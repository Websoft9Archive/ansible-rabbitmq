...
This repository install way is Package isntallation, you can  view the version from [Official URL](https://github.com/rabbitmq/rabbitmq-server/releases).  
